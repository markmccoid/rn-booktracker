...
export const MoreIcon = ({ size, color = undefined, style = undefined }) => {
  return (
    <AntDesign name="downcircleo" size={size} color={color} style={style} />
  );
};
...
export const InfinityIcon = ({
  ...
  return (
    <Ionicons name="ios-infinite" size={size} color={color} style={style} />
  );
};
